...
import 'package:flutter_canastas/data/repositories/tarea_proceso_repository_implementation.dart';
import 'package:flutter_canastas/domain/repositories/tarea_proceso_repository.dart';
import 'package:flutter_canastas/domain/use_cases/migrar/migrar_all_tarea_use_case.dart';
import 'package:flutter_canastas/domain/use_cases/migrar/upload_file_of_tarea_use_case.dart';
import 'package:flutter_canastas/domain/use_cases/tareas/delete_tarea_proceso_use_case.dart';
import 'package:flutter_canastas/domain/use_cases/tareas/get_all_tarea_proceso_use_case.dart';
import 'package:flutter_canastas/domain/use_cases/tareas/update_tarea_proceso_use_case.dart';
import 'package:flutter_canastas/ui/pages/migrar/migrar_controller.dart';
