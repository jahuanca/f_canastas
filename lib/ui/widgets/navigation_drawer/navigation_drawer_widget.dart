...
import 'package:flutter_canastas/core/styles.dart';
import 'package:flutter_canastas/ui/utils/preferencias_usuario.dart';
import 'package:flutter_canastas/ui/widgets/navigation_drawer/navigation_drawer_controller.dart';
      ...
      builder: (_) => Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            _itemDrawer(
                size, Icons.file_copy, 'Temporadas', () => _.goTemporadas(scaffoldKey)),
            _itemDrawer(
